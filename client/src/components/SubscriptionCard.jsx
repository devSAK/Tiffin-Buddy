...
export default function SubscriptionCard({
  ...
  hover:ring-2 hover:ring-blue-500 hover:shadow-lg hover:scale-105 transition duration-300 ease-in-out cursor-pointer"
    >
      ...
      <button className="mt-auto mb-3 w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md transition">
        Meal Chart
      </button>
      <button
        onClick={() => addToCart({ id, title, duration, price: offerPrice })}
        className="mt-auto w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition"
      >
        Choose Plan
      </button>
    </div>
